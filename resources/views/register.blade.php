    ...
    <div class="container">
        <div class="login-form">
            <div class="inside-login-form">
                ...
                <form action="{{ route('register.store') }}" method="POST" class="form-input" id="formLogin">
                    @csrf
                        <div class="input-primary">
                            <div class="padding-input"><i class="ri-user-line"></i></div>
                            <div class="input-form"><input type="text" name="name" placeholder="@error('name'){{ $message }}@else{{ 'name' }}@enderror" @error('name') class="error" @else value="{{ old('name') }}" @enderror></div>
                        </div>
                        <div class="input-primary">
                ...
                <div class="d-flex justify-content-between">
                    <button class="login-button my-0" id="loginButton">Register</button>
                    <a href="{{ route('login') }}" class="link-info my-2">Login</a>
                </div>
            </div>
        </div>
        <div class="welcome">
